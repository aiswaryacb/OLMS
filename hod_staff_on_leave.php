...
$row=mysqli_fetch_array($res);
	$fname= $row[1];
        ...
        $dpt=$row[6];
        $today=date('Y-m-d');
$leaves=mysqli_query($con,"select * from leave_requests where status='approved' AND department='$dpt';");
...
<ul>
 ...
 <li><a href="#hod_staff_on_leave.php" class="active">Staffs On Leave</a></li>
