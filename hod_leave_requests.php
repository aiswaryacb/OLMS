...
<ul>
 ...
 <li style="float:right"><a href="hod_chnge_pw.php">Change Password</a></li>
     ...
     <h2 style="color: red; text-align: center;">LEAVE REQUESTS</h2>  
<table>
    <tr>
        ...
        <td>
            ...
            <?php
            $lr= mysqli_query($con,"select * from leave_requests where department='$dpt' AND staff_id!='$hodid' AND status='applied'");
            
            if($row=mysqli_fetch_array($lr)){  
            ?>
            <h1 style="text-align: center;color:darkblue; ">Leave Applications</h1>
            <table>
                <tr>
                ...
                <form action="hod_leave_approved.php" method="post">
                <tr>
