...
<script src="JQ/pw.js" type="text/javascript"></script>
...
<div class="seek">
    <h2 style="color:green" align="center"><b>&nbsp&nbsp&nbspChange &nbspPassword&nbsp</b></h2>
<form action="staff_pw_msg.php" method="post" name="pw" id="pw">
