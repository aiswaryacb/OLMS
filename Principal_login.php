...
<div class="background">
    <div class="move">
    <h2 style="color:green"><b>&nbsp&nbsp&nbspPrincipal&nbspLogin</b></h2>
    <form action="principal_val.php" method="post">
        <p><label for = " Principal Id"><b>&nbsp&nbsp&nbsp&nbsp&nbspPrincipal&nbsp Id&nbsp&nbsp</b></label>
            <input type = "text" name = " PrincipalId" required/>
        <p><label for = " PPassword"><b>&nbsp&nbsp&nbsp&nbsp&nbspPassword&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
