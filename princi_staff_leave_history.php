...
<?php
            ...
            $resd= mysqli_query($con, "select * from principal_details where principal_id='$id';");
...
<div style="overflow-x:auto;">
  ...
  <table>
    ...
    <br><br>
    <p align="center">
    <button><a href='princi_leave_requests.php'>Back</a></button> 
    </p>
</div>
...
<?php
mysqli_close($con);
header('refresh:10;url:princi_leave_requests.php');
?>
